DatexControlledMode <- R6Class(
  ...
  public = list(
    ...
    o2_flow = 2.0, air_flow = 2.0, n2o_flow = 0.0,
    current_fio2 = 0.21, current_fin2o = 0.0, fio2_response_tau = 5.0,
    
    # Other device parameters...
    frequency = 12, tidal_volume = 500,
    ...
    initialize = function(name, settings = list(), node_id = NULL, bus = NULL) {
      ...
      self$set_mode(DatexModeControlled$new())
